    ...
    <div className="min-h-[100dvh] bg-[#050505] px-4 py-4">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#06D6A0]/15">
            <Truck className="h-4.5 w-4.5 text-[#06D6A0]" />
          </div>
          <h1 className="text-lg font-heading font-bold text-white">Shipping API</h1>
        </div>
      </div>
      ...
      <div className="mt-10 text-center">
        <div className="inline-block rounded-2xl bg-[#0e0e0e] border border-white/[0.06] px-6 py-4 max-w-sm">
          ...
          <span className="inline-block text-xs font-medium text-[#06D6A0] bg-[#06D6A0]/10 px-3 py-1 rounded-full">
            Coming Soon
          </span>
        </div>
      </div>
