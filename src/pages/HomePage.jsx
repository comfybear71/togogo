    ...
    <div className="relative flex min-h-[100dvh] flex-col items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md text-center">
          ...
          >
            <div className="flex items-center">
              ...
              {searchQuery.trim() && (
                <button
                  type="submit"
                  className="mr-1.5 flex h-7 w-7 items-center justify-center rounded-full bg-[#FF6B35] text-white transition-all hover:scale-110 hover:shadow-[0_0_20px_rgba(255,107,53,0.3)] active:scale-95"
                >
        ...
        >
          ...
          >
            <div className="flex items-center justify-center gap-3 rounded-[15px] bg-[#0a0a0a] px-6 py-3.5 transition-all duration-300 group-hover:bg-[#0a0a0a]/80">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-[#FF6B35]/20 to-[#06D6A0]/20 transition-transform duration-300 group-hover:scale-110">
          ...
          <div className="flex gap-3">
            ...
            >
              <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#06D6A0]/10 transition-all duration-300 group-hover:bg-[#06D6A0]/20 group-hover:scale-110">
            ...
            <button
              ...
              className="group flex-1 flex items-center justify-center gap-2.5 rounded-2xl bg-[#0e0e0e] border border-white/[0.06] px-4 py-3 transition-all duration-300 hover:border-[#FFD23F]/30 hover:shadow-[0_0_30px_rgba(255,210,63,0.08)]"
            >
              <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#FFD23F]/10 transition-all duration-300 group-hover:bg-[#FFD23F]/20 group-hover:scale-110">
