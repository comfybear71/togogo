          ...
          <div className="mb-5 flex flex-col gap-3 sm:flex-row sm:items-end">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/[0.08] bg-[#0a0a0a] px-4 py-2.5 text-sm uppercase text-white placeholder-zinc-600 focus:border-[#FF6B35] focus:outline-none focus:ring-2 focus:ring-[#FF6B35]/20"
              />
            </div>
            <div className="w-32">
              ...
              <tbody>
                {promoCodes.map((p) => (
                  <tr key={p.id} className="border-b border-white/[0.04]">
                    ...
                    <td className="py-3 pr-4 text-zinc-400">{p.expiry}</td>
                    <td className="py-3 pr-4">
                      <span
                        className={`inline-block rounded-full px-2.5 py-0.5 text-xs font-medium ${
                          p.active ? 'bg-[#06D6A0]/10 text-[#06D6A0]' : 'bg-white/[0.06] text-zinc-500'
                        }`}
                      >
                    ...
                    <td className="py-3 text-right">
                      <button className="rounded-lg p-1.5 text-red-400 hover:bg-red-500/10 hover:text-red-400">
        ...
        <div className="rounded-[16px] bg-[#111] p-6">
          ...
          <div className="mb-5 flex flex-col gap-3 rounded-xl border border-dashed border-white/[0.1] bg-[#0a0a0a] p-4 sm:flex-row sm:items-end">
            ...
            <div>
              ...
              <button className="flex items-center gap-2 rounded-xl border border-white/[0.08] bg-[#0a0a0a] px-4 py-2.5 text-sm text-zinc-500 hover:border-[#FF6B35] hover:text-[#FF6B35]">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    {b.active ? (
                      ...
                      <ToggleLeft className="h-7 w-7 text-zinc-700" />
                    )}
